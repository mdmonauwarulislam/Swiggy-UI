...
export default function Card(props) {
  return (
    <div className="w-full md:w-[273px] shrink-0 grow">
      <div className="group h-[182px] rounded-[15px] overflow-hidden relative px-3">
        <img
      ...
      <div className="ml-3">
        <h1 className="mt-3 text-xl font-semibold">{props.title}</h1>
        <div className="flex items-center gap-2 ">
          ...
          <h1 className="font-semibold">{props.rating} •</h1>
          <h1 className="font-semibold">{props.minTime}-{props.maxTime} mins</h1>
